...
ftr, trgt = shuffle(ftr, trgt, random_state = 188)

# Split data into training/validation (80%) and test (20%) sets
ftr_train_val, ftr_test, trgt_train_val, trgt_test = train_test_split(ftr, trgt, test_size = 0.2, random_state = 230)

# Further split training/validation set into training and validation sets
ftr_train, ftr_val, trgt_train, trgt_val = train_test_split(ftr_train_val, trgt_train_val, test_size = 0.3, random_state = 250)
...
gbc = GradientBoostingClassifier(random_state = 559)
